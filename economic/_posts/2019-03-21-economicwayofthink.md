...
- 以校园电影院出售电影票为例，分析市场过程。
  ...
  + 以总价的差值/价格的变动，计算出价格浮动时，单位边际成本并绘制成图。单价从4.5涨至5时，25/50 = 0.5美元；单价从5涨至5.5时，-25/50 = -0.5美元；
  ...
  + 通过之前的图表分析，将价格需求曲线对y轴做垂直线，连接垂线的中点形成的直线就为边际收益
  + 影院中剩余的座位是否被“浪费”？因为多出售一张票的边际成本大于了边际收益，所以对影院经营者来说这才是有效率的
  + 如果不希望这样的“浪费”发生，只有在差别定价(支付意愿强的收高价，支付意愿低的收低价)这一行为的成本足够低时，才会发生
  + 我们来看看常青藤学院是怎么做的，我们假设多招收一名学员的边际成本为0  
  {% include academy.html %}
  + 根据图中分析，当学费定价为3万美元的时候，边际收益为零，3000名学生入学，学校将会收益9000万美元  
  + 有的学生家境好，愿意支付更高的价格。同时有些学生无法负担这个学费。所有这一切算不算一种"浪费"？
  + 奖学金来了，学校直接将学费定位六万美元，并且要求学生填写家境报告单。以此甄别家庭经济状况并选择性的给予部分价格回扣。此时学校的收益将会是整个需求曲线涵盖的部分，为1.8亿美元  
  + 差别定价的策略。游乐园为小孩打折、机票为普通旅客打折(而非商务旅客)。低成本识别出需求弹性大的客户，并防止他们转让商品给需求弹性小的客户  
  + 重新回到看电影，以学生/老师的身份来区别定价，这样就能获得更大收益，并且要安抚高价者的情绪，合理化辩解非常重要  
